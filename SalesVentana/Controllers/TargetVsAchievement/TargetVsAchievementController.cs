...
namespace SalesVentana.Controllers
{
    [Authorize]
    [RoutePrefix("api/po")]
    public class TargetVsAchievementController : ApiControllerBase
    {
        IPurchaseOrderRepository _purchaseOrderRepository = null;

        public TargetVsAchievementController(IBaseRepository<Error> errorRepository, IPurchaseOrderRepository purchaseOrderRepository,
